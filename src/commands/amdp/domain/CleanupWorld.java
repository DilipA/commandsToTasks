...
public class CleanupWorld implements DomainGenerator{
	...
	public static void main(String [] args){
		...
		if(runGroundLevelBoundedRTDP){
			...
			StateConditionTest sc = new CleanupL1AMDPDomain.GroundedPropSC(new GroundedProp(domain.getPropFunction(CleanupWorld.PF_BLOCK_IN_ROOM),  new String[]{"block0", "room1"}));
