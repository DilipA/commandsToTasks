...
import commands.amdp.framework.AMDPAgent;
import commands.amdp.framework.AMDPPolicyGenerator;
...
public class CleanupDomainDriverWithBaseLevelComparison {
	...
	public static void main(String[] args) {
		...
		if(runGroundLevelBoundedRTDP){
			...
			StateConditionTest sc = new CleanupL1AMDPDomain.GroundedPropSC(new GroundedProp(domain.getPropFunction(CleanupWorld.PF_BLOCK_IN_ROOM),  new String[]{"block0", "room3"}));

			RewardFunction heuristicRF = new PullCostGoalRF(sc, 1., 0.);


			CleanupL1AMDPDomain.GroundedPropSC l0sc = new CleanupL1AMDPDomain.GroundedPropSC(new GroundedProp(domain.getPropFunction(CleanupWorld.PF_BLOCK_IN_ROOM), new String[]{"block0", "room3"}));
