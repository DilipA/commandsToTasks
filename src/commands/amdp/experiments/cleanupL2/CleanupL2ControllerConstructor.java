...
public class CleanupL2ControllerConstructor implements ControllerConstructor {
    ...
    public Map<String, String> getExpertDatasetRFLabels() {
        ...
        labels.put("go|to|red|door|go|into|red|room|go|to|green|door.txt", "agentInRegion(agent0, room1)");
        labels.put("go|to|red|door|go|into|red|room|go|to|green|door|go|into|green|room.txt", "agentInRegion(agent0, room1)");
        labels.put("go|to|red|door|go|into|red|room|move|bag|to|green|door|go|to|red|door.txt", "agentInRegion(agent0, room0)");
        ...
        labels.put("go|to|red|door|go|into|red|room|move|bag|to|red|door.txt", "blockInRegion(block0, room0)");
        labels.put("go|to|red|door|go|into|red|room|move|bag|to|red|door|go|to|green|door.txt", "agentInRegion(agent0, room0) blockInRegion(block0, room0)");
        ...
        labels.put("go|to|red|door|go|to|red|room|move|bag|to|green|door.txt", "blockInRegion(block0, room1)");
        ...
        labels.put("move|through|red|door|to|the|red|room|then|carry|the|bag|through|green|door.txt", "blockInRegion(block0, room1)");
