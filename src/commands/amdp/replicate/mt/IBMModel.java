...
import commands.amdp.replicate.structures.AlignedSent;
import commands.amdp.replicate.structures.DefaultDict;
import commands.amdp.replicate.structures.ParallelCorpus;
...
public abstract class IBMModel {
    ...
    public IBMModel(ParallelCorpus corpus) {
        ...
        this.targetPrior = 1.0;
    }

    public void remakePriors(){
    ...
    public void updateVocabulary(ParallelCorpus corpus) {
        ...
        this.sourceVocabulary.clear();
        this.targetVocabulary.clear();
